...
gr_series_mod_set_other(gr_poly_t res, gr_srcptr x, gr_ctx_t x_ctx, gr_ctx_t ctx)
{
    ...
    {
        if (GR_SERIES_MOD_N(ctx) <= GR_SERIES_MOD_N(x_ctx))   /* set() does modular reduction */
...
/*
    {GR_METHOD_GAMMA,       (gr_funcptr) gr_series_mod_gamma},
    {GR_METHOD_RGAMMA,      (gr_funcptr) gr_series_mod_rgamma},
    {GR_METHOD_LGAMMA,      (gr_funcptr) gr_series_mod_lgamma},
    {GR_METHOD_DIGAMMA,     (gr_funcptr) gr_series_mod_digamma},
    {GR_METHOD_ERF,         (gr_funcptr) gr_series_mod_erf},
    {GR_METHOD_ERFC,        (gr_funcptr) gr_series_mod_erfc},
    {GR_METHOD_ERFI,        (gr_funcptr) gr_series_mod_erfi},
    {GR_METHOD_FRESNEL,     (gr_funcptr) gr_series_mod_fresnel},
    {GR_METHOD_FRESNEL_S,   (gr_funcptr) gr_series_mod_fresnel_s},
    {GR_METHOD_FRESNEL_C,   (gr_funcptr) gr_series_mod_fresnel_c},
    {GR_METHOD_AIRY,        (gr_funcptr) gr_series_mod_airy},
    {GR_METHOD_AIRY_AI,        (gr_funcptr) gr_series_mod_airy_ai},
    {GR_METHOD_AIRY_AI_PRIME,  (gr_funcptr) gr_series_mod_airy_ai_prime},
    {GR_METHOD_AIRY_BI,        (gr_funcptr) gr_series_mod_airy_bi},
    {GR_METHOD_AIRY_BI_PRIME,  (gr_funcptr) gr_series_mod_airy_bi_prime},
    {GR_METHOD_EXP_INTEGRAL_EI,       (gr_funcptr) gr_series_mod_exp_integral_ei},
    {GR_METHOD_COS_INTEGRAL,          (gr_funcptr) gr_series_mod_cos_integral},
    {GR_METHOD_COSH_INTEGRAL,         (gr_funcptr) gr_series_mod_cosh_integral},
    {GR_METHOD_SIN_INTEGRAL,          (gr_funcptr) gr_series_mod_sin_integral},
    {GR_METHOD_SINH_INTEGRAL,         (gr_funcptr) gr_series_mod_sinh_integral},
    {GR_METHOD_LOG_INTEGRAL,          (gr_funcptr) gr_series_mod_log_integral},
    {GR_METHOD_GAMMA_UPPER,           (gr_funcptr) gr_series_mod_gamma_upper},
    {GR_METHOD_GAMMA_LOWER,           (gr_funcptr) gr_series_mod_gamma_lower},
    {GR_METHOD_BETA_LOWER,            (gr_funcptr) gr_series_mod_beta_lower},
    {GR_METHOD_HYPGEOM_PFQ,           (gr_funcptr) gr_series_mod_hypgeom_pfq},
    {GR_METHOD_HURWITZ_ZETA,          (gr_funcptr) gr_series_mod_hurwitz_zeta},
    {GR_METHOD_POLYLOG,               (gr_funcptr) gr_series_mod_polylog},
    {GR_METHOD_DIRICHLET_L,           (gr_funcptr) gr_series_mod_dirichlet_l},
    {GR_METHOD_DIRICHLET_HARDY_Z,     (gr_funcptr) gr_series_mod_dirichlet_hardy_z},
    {GR_METHOD_DIRICHLET_HARDY_THETA, (gr_funcptr) gr_series_mod_dirichlet_hardy_theta},
    {GR_METHOD_JACOBI_THETA,          (gr_funcptr) gr_series_mod_jacobi_theta},
    {GR_METHOD_JACOBI_THETA_1,          (gr_funcptr) gr_series_mod_jacobi_theta_1},
    {GR_METHOD_JACOBI_THETA_2,          (gr_funcptr) gr_series_mod_jacobi_theta_2},
    {GR_METHOD_JACOBI_THETA_3,          (gr_funcptr) gr_series_mod_jacobi_theta_3},
    {GR_METHOD_JACOBI_THETA_4,          (gr_funcptr) gr_series_mod_jacobi_theta_4},
    {GR_METHOD_AGM1,                   (gr_funcptr) gr_series_mod_agm1},
    {GR_METHOD_ELLIPTIC_K,             (gr_funcptr) gr_series_mod_elliptic_k},
    {GR_METHOD_WEIERSTRASS_P,          (gr_funcptr) gr_series_mod_weierstrass_p},
*/
    {0,                     (gr_funcptr) NULL},
};
